...
if (stateSelect) {
  ...
  stateSelect.addEventListener("change", async function () {
    ...
    // Static district data — no backend needed (geographic data never changes)
    const DISTRICTS_BY_STATE = {
      ...
      "Andhra Pradesh": ["Alluri Sitharama Raju","Anakapalli","Ananthapuramu","Bapatla","East Godavari","Eluru","Guntur","Kadapa","Kakinada","Konaseema","Krishna","Kurnool","Nandyal","NTR","Palnadu","Parvathipuram Manyam","Prakasam","Srikakulam","Sri Potti Sriramulu Nellore","Sri Sathya Sai","Tirupati","Visakhapatnam","Vizianagaram","West Godavari","YSR Kadapa"],
      ...
      "Nagaland": ["Chumoukedima","Dimapur","Kiphire","Kohima","Longleng","Mokokchung","Mon","Noklak","Peren","Phek","Tseminyü","Tuensang","Wokha","Zunheboto"],
    ...
    if (districts.length === 0) {
      districtSelect.innerHTML = '<option value="">No districts found for selected state</option>';
    } else {
